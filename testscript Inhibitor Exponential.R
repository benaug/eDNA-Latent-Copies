#inhibitors, exponential survival
...
library(nimble)
library(coda)
source("Release NimModel Inhibit Exponential.R")
...
parameters <- c('alpha0','zeta0','gamma0','gamma1','p0','theta0','tau','sd.w',
...
Cmcmc$run(1000,reset=FALSE) #short run for demonstration. Can run repeatedly to get more posterior samples.
end.time <- Sys.time()
