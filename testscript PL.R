#No inhibitors, power law survival
source("sim.data.R")
...
constants <- list(M=M,J=J,K=K,eta.q=eta.q,Q=Q,v=v,dist=dist) #model file set up to use fixed v
Nimdata <- list(y=data$y,y.det=data$y.det,volume.rep=volume.rep)

# set parameters to monitor
parameters <- c('alpha0','zeta0','gamma0','gamma1','p0','lambda.site','theta.site')
